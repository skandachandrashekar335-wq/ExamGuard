        ...
        <div className="eg-container">
          ...
          <div className="eg-bento">
            ...
            <div className="eg-bento__item eg-bento__item--wide">
              <div className="glass eg-bento__card eg-bento__card--wide">
                <div className="eg-bento__card-bg" aria-hidden="true">
                  <svg viewBox="0 0 600 300" fill="none" className="eg-bento__card-bg-svg">
                    <circle cx="480" cy="150" r="120" stroke="var(--accent)" strokeWidth="0.5" opacity="0.08" />
                    <circle cx="480" cy="150" r="80" stroke="var(--accent)" strokeWidth="0.5" opacity="0.06" />
                    <circle cx="480" cy="150" r="40" stroke="var(--accent)" strokeWidth="0.5" opacity="0.04" />
                  </svg>
                </div>
                <div className="eg-bento__card-content">
                ...
                <div className="eg-bento__card-visual">
                  <svg viewBox="0 0 180 220" className="eg-face-visual">
                    <defs>
                    ...
                    <rect x="20" y="10" width="140" height="200" rx="14" fill="url(#faceGrad)" stroke="var(--border)" strokeWidth="1" />
                    <ellipse cx="90" cy="85" rx="34" ry="42" fill="none" stroke="var(--accent)" strokeWidth="1.5" opacity="0.6" />
                    <circle cx="78" cy="76" r="3" fill="var(--accent)" opacity="0.7" />
                    <circle cx="102" cy="76" r="3" fill="var(--accent)" opacity="0.7" />
                    <path d="M82 95 Q90 105 98 95" fill="none" stroke="var(--accent)" strokeWidth="1.2" opacity="0.5" />
                    <line x1="40" y1="155" x2="140" y2="155" stroke="var(--accent)" strokeWidth="0.75" opacity="0.2" />
                    <line x1="50" y1="165" x2="130" y2="165" stroke="var(--accent)" strokeWidth="0.75" opacity="0.15" />
                    <line x1="55" y1="175" x2="125" y2="175" stroke="var(--accent)" strokeWidth="0.75" opacity="0.1" />
                    <line x1="60" y1="185" x2="120" y2="185" stroke="var(--accent)" strokeWidth="0.75" opacity="0.08" />
                    <rect x="30" y="20" width="120" height="180" rx="10" fill="none" stroke="var(--accent)" strokeWidth="0.75" strokeDasharray="3 3" opacity="0.3" />
                    <circle cx="90" cy="85" r="46" fill="none" stroke="var(--accent)" strokeWidth="0.5" strokeDasharray="2 4" opacity="0.2">
                    ...
                    <circle cx="90" cy="85" r="56" fill="none" stroke="var(--accent)" strokeWidth="0.3" strokeDasharray="2 6" opacity="0.1">
