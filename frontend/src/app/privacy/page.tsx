    ...
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        ...
        <div className="space-y-12">
          <section>
            <h2 className="text-xl font-bold uppercase tracking-wider mb-4">1. Overview</h2>
          ...
          <section>
            <h2 className="text-xl font-bold uppercase tracking-wider mb-4">2. Data Collected</h2>
            <div className="space-y-4">
              ...
              <div className="eg-card">
                <h3 className="text-sm font-bold uppercase tracking-wider mb-2 text-[var(--accent-amber)]">
              ...
              <div className="eg-card">
                <h3 className="text-sm font-bold uppercase tracking-wider mb-2 text-[var(--accent-pink)]">
          ...
          <section>
            <h2 className="text-xl font-bold uppercase tracking-wider mb-4">3. Biometric Data</h2>
            <div className="eg-card border-[var(--accent-amber)]/30">
              <p className="text-[var(--text-secondary)] text-sm leading-relaxed mb-3">
                <strong className="text-[var(--accent-amber)]">Currently implemented:</strong> No biometric
              ...
              <p className="text-[var(--text-secondary)] text-sm leading-relaxed mb-3">
                <strong className="text-[var(--accent-amber)]">Planned for future:</strong> Phase 8 of the
          ...
          <section>
            <h2 className="text-xl font-bold uppercase tracking-wider mb-4">4. Data Processing</h2>
            <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-xl font-bold uppercase tracking-wider mb-4">5. Data Storage</h2>
            <p className="text-[var(--text-secondary)] leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold uppercase tracking-wider mb-4">6. Data Retention</h2>
            <p className="text-[var(--text-secondary)] leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold uppercase tracking-wider mb-4">7. Access Controls</h2>
            <p className="text-[var(--text-secondary)] leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold uppercase tracking-wider mb-4">8. Third-Party Services</h2>
            <p className="text-[var(--text-secondary)] leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold uppercase tracking-wider mb-4">9. Changes to This Policy</h2>
            <p className="text-[var(--text-secondary)] leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold uppercase tracking-wider mb-4">10. Contact</h2>
            <p className="text-[var(--text-secondary)] leading-relaxed">
